...
while(run == True):
        ...
        def switch_interface():
            root.withdraw()  # Hide the current interface
        ...
        def back_to_menu():
            ...
            score_board.withdraw()
            root.deiconify()  # Show the main menu interface
        ...
        jpg1_image = Image.open("begi.jpg")
